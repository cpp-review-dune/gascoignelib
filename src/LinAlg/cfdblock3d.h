...
protected:
  ...
  void swap(MatrixEntryType a, MatrixEntryType b) const
  {
    MatrixEntryType c = a;
    a                 = b;
    b                 = c;
...
public:
  ...
  MatrixEntryType laplx() const
  {
    return lapx;
  }
  MatrixEntryType laply() const
  {
    return lapy;
  }
  MatrixEntryType laplz() const
  {
    return lapz;
  }
  MatrixEntryType divx() const
  {
    return dx;
  }
  MatrixEntryType divy() const
  {
    return dy;
  }
  MatrixEntryType divz() const
  {
    return dz;
  }
  MatrixEntryType stab() const
  {
    return s;
  }
  MatrixEntryType gradx() const
  {
    return gx;
  }
  MatrixEntryType grady() const
  {
    return gy;
  }
  MatrixEntryType gradz() const
  {
    return gz;
  }

  MatrixEntryType& laplx()
  {
    return lapx;
  }
  MatrixEntryType& laply()
  {
    return lapy;
  }
  MatrixEntryType& laplz()
  {
    return lapz;
  }
  MatrixEntryType& divx()
  {
    return dx;
  }
  MatrixEntryType& divy()
  {
    return dy;
  }
  MatrixEntryType& divz()
  {
    return dz;
  }
  MatrixEntryType& stab()
  {
    return s;
  }
  MatrixEntryType& gradx()
  {
    return gx;
  }
  MatrixEntryType& grady()
  {
    return gy;
  }
  MatrixEntryType& gradz()
  {
    return gz;
  }
  ...
  {
    std::cerr << "\"std::ostream& operator<<(std::ostream &s, const "
                 "CFDBlock3d& A)\" not written!"
              << std::endl;
    abort();
  }
};
