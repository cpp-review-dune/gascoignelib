...
namespace Gascoigne
{
  ...
  void HNStructureQ42d::add_column(
  ...
  void HNStructureQ42d::modify_row_higher(EntryMatrix &E,
                                          const vector<int> &hang,
                                          const IntVector &indices) const
  {
    EntryMatrix T = E;
  ...
  void HNStructureQ42d::modify_row_lower(EntryMatrix &E,
                                         const vector<int> &hang,
                                         const IntVector &indices) const
  {
    EntryMatrix T = E;
