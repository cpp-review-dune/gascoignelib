...
public:
  std::map<int, std::array<int, 2>>& GetZweier()
  {
    return zweier;
  }
  std::map<int, std::array<int, 4>>& GetVierer()
  {
    return vierer;
  }
  std::map<int, std::array<int, 8>>& GetAchter()
  {
    return achter;
  }
  IntVector& GetC2F()
  ...
  const std::map<int, std::array<int, 2>>& GetZweier() const
  {
    return zweier;
  }
  const std::map<int, std::array<int, 4>>& GetVierer() const
  {
    return vierer;
  }
  const std::map<int, std::array<int, 8>>& GetAchter() const
  {
    return achter;
  }
  const IntVector& GetC2F() const
  {
    return c2f;
  }
