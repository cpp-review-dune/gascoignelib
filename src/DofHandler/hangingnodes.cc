...
template <>
void HangingNodes<2, 2>::CondenseHanging(EntryMatrix& E, IntVector& indices) const
{
...
template <>
void HangingNodes<2, 3>::CondenseHanging(EntryMatrix& E, IntVector& indices) const
{
...
template <>
void HangingNodes<3, 2>::CondenseHanging(EntryMatrix& E, IntVector& indices) const
{
  if (1)
  {
    IntVector x(0), y(0);
...
template <>
void HangingNodes<3, 3>::CondenseHanging(EntryMatrix& E, IntVector& indices) const
{
  if (1)
  {
    IntVector x(0), y(0);
