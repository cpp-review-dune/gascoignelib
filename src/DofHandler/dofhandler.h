...
public:
  ...
  virtual const IntVector& GetCellVector() const
  {
    return nc;
  }
  virtual const IntVector& GetMaterialVector() const
  {
    return mat;
  }
  virtual const IntVector& GetMaterialPatchVector() const
  {
    return matpatch;
  }
  ...
  virtual const IntVector* Vertexo2n() const
  {
    return &vo2n;
  }

  virtual IntVector& GetCellVector()
  {
    return nc;
  }
  virtual IntVector& GetMaterialVector()
  {
    return mat;
  }
  virtual IntVector& GetMaterialPatchVector()
  {
    return matpatch;
  }

  virtual PatchIndexHandler& GetPatchIndexHandler()
  {
    return PatchHandler;
  }
  ...
  virtual bool HasPatch() const
  {
    return PatchHandler.HasPatch();
  }
  virtual bool HasQ4Patch() const
  {
    return PatchHandler.HasQ4Patch();
  }
  virtual int npatches() const
  {
    return PatchHandler.npatches();
  }
  virtual int nq4patches() const
  {
    return PatchHandler.nq4patches();
  }
  ...
  // VANKA: muss weg
  virtual const IntVector& GetMaterialVankaVector() const
  {
    return mat_Vanka;
  }
  ...
  virtual const std::vector<std::array<Vertex3d, 3>>& GetbasisVankaVector() const
  {
    return basis_Vanka;
  }
  virtual const std::vector<std::array<Vertex3d, 3>>& GetbasisVankaPatchVector() const
  {
    return basis_Vanka_patch;
  }
  virtual IntVector& GetMaterialVankaVector()
  {
    return mat_Vanka;
  }
  virtual IntVector& GetMaterialVankaPatchVector()
  {
    return mat_Vanka_patch;
  }
...
public:
  ...
  std::vector<Vertex<DIM>>& GetVertexVector()
  {
    return nx;
  }
  const std::vector<Vertex<DIM>>& GetVertexVector() const
  {
    return nx;
  }
  ...
  int nhanging() const
  {
    return HangingHandler.GetStructure()->size();
  }

  constexpr int nodes_per_cell(int i) const
  {
    return (DIM == 2) ? 4 : 8;
  }
