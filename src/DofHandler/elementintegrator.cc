...
////////////////////////////////////////////////// required for LPS
template class ElementIntegrator<2, PatchFormula2d<4, QuadGauss4>, PatchFormula2d<9, QuadGauss9>,
                                 PatchFormula1d<2, LineGauss2>, PatchFormula2d<4, QuadGauss4>>;
template class ElementIntegrator<3, PatchFormula3d<8, HexGauss8>, PatchFormula3d<27, HexGauss27>,
