...
template<>
inline double
CGBase<2, 2>::psi(int i, double x) const
{
...
template<>
inline double
CGBase<2, 3>::psi(int i, double x) const
{
  return (alpha[i][0] * x + alpha[i][1]) * x + alpha[i][2];
}
template<>
inline double
CGBase<2, 3>::psi_x(int i, double x) const
{
...
template<>
inline double
CGBase<2, 5>::psi(int i, double x) const
{
  return alpha[i][4] +
         x * (alpha[i][3] +
...
template<>
inline double
CGBase<2, 5>::psi_x(int i, double x) const
{
...
template<>
inline double
CGBase<3, 2>::psi(int i, double x) const
{
  return alpha[i][0] * x + alpha[i][1];
}
template<>
...
template<>
inline double
CGBase<3, 3>::psi(int i, double x) const
{
  return (alpha[i][0] * x + alpha[i][1]) * x + alpha[i][2];
}
template<>
inline double
CGBase<3, 3>::psi_x(int i, double x) const
{
  return 2.0 * alpha[i][0] * x + alpha[i][1];
}
// q4
template<>
inline double
CGBase<3, 5>::psi(int i, double x) const
{
  return alpha[i][4] +
         x * (alpha[i][3] +
              x * (alpha[i][2] + x * (alpha[i][1] + x * alpha[i][0])));
...
template<>
inline double
CGBase<3, 5>::psi_x(int i, double x) const
{
  return alpha[i][3] + x * (2.0 * alpha[i][2] +
                            x * (3.0 * alpha[i][1] + x * 4.0 * alpha[i][0]));
}
