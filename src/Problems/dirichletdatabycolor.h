...
public:
  DirichletDataByColor(const ParamFile &pf, nvector<int> comps,
                       const std::set<int> &cl, nvector<double> s);
  DirichletDataByColor(nvector<int> comps, const std::set<int> &cl,
                       nvector<double> s);
