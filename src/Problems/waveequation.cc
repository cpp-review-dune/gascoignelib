...
double
WaveEquation::Laplace(const TestFunction& U, const TestFunction& N) const
{
...
void
WaveEquation::Form(VectorIterator b,
                   const FemFunction& U,
...
void
WaveEquation::Matrix(EntryMatrix& A,
                     const FemFunction& U,
...
void
WaveBoundaryEquation::Form(VectorIterator b,
                           const FemFunction& U,
...
void
WaveBoundaryEquation::Matrix(Gascoigne::EntryMatrix& A,
