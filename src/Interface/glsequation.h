...
public:
  ...
  //
  virtual void L(DoubleVector& dst, const FemFunction& U) const=0;
  //
  ...
  //
  virtual void SMatrix(DoubleVector& dst, const FemFunction& U, const FemFunction& M, const FemFunction& N) const {}
};
}
