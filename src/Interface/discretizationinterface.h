...
public:
  ...
  virtual int
  nelements() const = 0; // returns the number of elements in the discretization
  ...
  virtual void Form(GlobalVector &f, const GlobalVector &u, const Equation &EQ,
                    double d) const {
    assert(0);
  }
  ...
  virtual void Matrix(MatrixInterface &A, const GlobalVector &u,
                      const Equation &EQ, double) const {
    assert(0);
  }

  virtual void AdjointForm(GlobalVector &f, const GlobalVector &u,
                           const Equation &EQ, double d) const {
    std::cerr << "\"DiscretizationInterface::AdjointForm\" not written!"
              << std::endl;
    abort();
  }
  virtual void BoundaryMatrix(MatrixInterface &A, const GlobalVector &u,
  ...
  virtual void VisuVtk(const ComponentInformation *CI, const ParamFile &pf,
                       const std::string &name, const GlobalVector &u,
                       int i) const {
  ...
  // New Inteface.
  virtual void BoundaryForm(GlobalVector &f, const GlobalVector &u,
  ...
  virtual void MassForm(GlobalVector &f, const GlobalVector &u,
                        const TimePattern &TP, double s) const {
    std::cerr << "\"DiscretizationInterface::MassForm\" not written!"
              << std::endl;
    abort();
  }
  virtual void DiracRhs(GlobalVector &f, const DiracRightHandSide &DRHS,
                        double s) const {
    std::cerr << "\"DiscretizationInterface::DiracRhs\" not written!"
              << std::endl;
    abort();
  }
  virtual void BoundaryRhs(GlobalVector &f, const IntSet &Colors,
  ...
  virtual void InterpolateDirac(GlobalVector &u,
                                const GlobalVector &uold) const {
    std::cerr << "\"DiscretizationInterface::InterpolateDirac\" not written!"
              << std::endl;
    abort();
  }
  virtual void StrongDirichletMatrix(MatrixInterface &A, int col,
  ...
  virtual void
  StrongDirichletMatrixOnlyRow(MatrixInterface &A, int col,
                               const std::vector<int> &comp) const {
  ...
  virtual void StrongDirichletVector(GlobalVector &u, const DirichletData &BF,
                                     int col, const std::vector<int> &comp,
                                     double d = 1.) const {
    std::cerr
  ...
  virtual void StrongDirichletVectorZero(GlobalVector &u, int col,
                                         const std::vector<int> &comp) const {
    std::cerr
  ...
  virtual void StrongPeriodicVector(GlobalVector &u, const PeriodicData &BF,
                                    int col, const std::vector<int> &comp,
                                    double d = 1.) const {
    std::cerr
  ...
  virtual void StrongDirichletVector(GlobalVector &u, const DirichletData *DD,
                                     double d = 1.) const {
  ...
  virtual void
  StrongDirichletVectorZero(GlobalVector &u,
  ...
  virtual void
  StrongDirichletMatrix(MatrixInterface &A,
                        const ProblemDescriptorInterface &PD) const {
  ...
  virtual void StabForm(GlobalVector &f, const GlobalVector &u,
  ...
  // Functionals
  virtual void ComputeError(const GlobalVector &u, LocalVector &err,
                            const ExactSolution *ES) const {
    std::cerr << "\"DiscretizationInterface::ComputeError\" not written!"
              << std::endl;
    abort();
  }
  virtual void AssembleError(GlobalVector &eta, const GlobalVector &u,
                             LocalVector &err, const ExactSolution *ES) const {
  ...
  virtual void
  EvaluateBoundaryCellRightHandSide(GlobalVector &f, const IntSet &Colors,
  ...
  virtual void
  EvaluateBoundaryParameterRightHandSide(GlobalVector &f, const IntSet &Colors,
                                         const BoundaryRightHandSide &CF,
                                         double d = 1.) const {
    std::cerr << "\"DiscretizationInterface::"
  ...
  virtual void RhsCurve(GlobalVector &F, const Curve &C, int comp,
                        int N) const {
