...
public:
  ...
  int& CountResidual() const
  {
    return _countresidual;
  }

  int CoarseLevel() const
  {
    return _coarselevel;
  }
  ...
  const std::string& LinearSolve() const
  {
    return _linearsolve;
  }
  std::string& NonLinearSolve()
  {
  ...
  {
    return _gmresmemsize;
  }
  CGInfo& GetPrecInfo()
  {
    return precinfo;
  }
  const CGInfo& GetPrecInfo() const
  {
    return precinfo;
  }
  ...
  {
    return _i_save_linear_comp_residuals;
  }
  ...
  {
    return _i_show_linear_comp_residuals;
  }
  int ShowCompResidualNames() const
  {
    return (_i_show_comp_residual_names
            && (_i_show_nonlinear_comp_residuals || _i_show_linear_comp_residuals));
  }
};
