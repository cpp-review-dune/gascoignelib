...
protected:
  ...
  double ScalarProduct(DoubleVector& eta, const GlobalVector& f,
                       const GlobalVector& z) const;
  double ScalarProduct(DoubleVector& eta, const VectorInterface& gf,
...
public:
  ...
  double Estimator(DoubleVector& eta, VectorInterface& gf, const VectorInterface& gu,
                   const VectorInterface& gz, const ProblemDescriptorInterface& PDI);
};
