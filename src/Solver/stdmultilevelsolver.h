...
public:
  ...
  virtual void mgstep(std::vector<double> &res, std::vector<double> &rw, int l,
                      int maxl, int minl, std::string &p0, std::string p,
                      const Matrix &A, VectorInterface &u, VectorInterface &b,
                      VectorInterface &v);

  virtual void Cg(VectorInterface &x, const VectorInterface &f, CGInfo &info);
  virtual void Gmres(const Matrix &A, VectorInterface &x,
  ...
  virtual std::string LinearSolve(int level, const Matrix &A,
                                  VectorInterface &u, const VectorInterface &b,
                                  CGInfo &info);
  virtual std::string Solve(int level, Matrix &A, VectorInterface &x,
                            const VectorInterface &b, NLInfo &nlinfo);
  virtual std::string Solve(Matrix &A, VectorInterface &x,
                            const VectorInterface &b, NLInfo &nlinfo) {
  ...
  virtual double NewtonUpdate(double &rr, VectorInterface &x,
                              VectorInterface &dx, VectorInterface &r,
                              const VectorInterface &f, NLInfo &nlinfo);
  virtual void NewtonLinearSolve(const Matrix &A, VectorInterface &x,
                                 const VectorInterface &b, CGInfo &info);
  virtual void NewtonMatrixControl(Matrix &A, VectorInterface &u,
                                   NLInfo &nlinfo);
  ...
  virtual void LinearMg(int minlevel, int maxlevel, const Matrix &A,
                        VectorInterface &u, const VectorInterface &f, CGInfo &);
  ...
  virtual void precondition(const Matrix &A, VectorInterface &x,
                            VectorInterface &y);
  ...
  virtual void newton(Matrix &A, VectorInterface &u, const VectorInterface &f,
