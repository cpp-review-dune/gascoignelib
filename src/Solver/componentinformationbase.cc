...
const int ComponentInformationBase::GetNScalars() const
{
  ...
  if (pbrhs != NULL)
  {
    ncomps = ncomps_brhs = pbrhs->GetNcomp();
  }
  ...
  if (peq != NULL)
  {
    ncomps = ncomps_equation = peq->GetNcomp();
  }
  ...
  if (pbeq != NULL)
  {
    ncomps = ncomps_boundaryequation = pbeq->GetNcomp();
  }
  ...
  assert(0 < ncomps);
  if (0 < ncomps_rhs)
    assert(ncomps == ncomps_rhs);
  if (0 < ncomps_brhs)
    assert(ncomps == ncomps_brhs);
  if (0 < ncomps_equation)
    assert(ncomps == ncomps_equation);
  if (0 < ncomps_boundaryequation)
    assert(ncomps == ncomps_boundaryequation);
  if (0 < ncomps_initialcondition)
    assert(ncomps == ncomps_initialcondition);
