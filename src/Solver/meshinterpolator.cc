...
public:
  ...
  {
    return "ProjectionRightHandSide";
  }
...
void MeshInterpolator::BasicInit(DiscretizationInterface* DI, MeshAgentInterface* MA,
                                 const string& name)
{
  _name = name;
                                                   ...
                                                   const GlobalVector& uOld)
{
  ...
  vector<vector<bool>> doneOld(_VecOld.size(), vector<bool>(_Old->nnodes(), true)),
...
void MeshInterpolator::InterpolateCellVector(GlobalVector& out, const GlobalVector& in)
{
  ...
  vector<vector<bool>> doneOld(_VecOld.size(), vector<bool>(_Old->ncells(), true)),
