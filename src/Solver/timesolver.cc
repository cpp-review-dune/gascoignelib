...
namespace Gascoigne
{
void TimeSolver::SetTimeData(double _dt, double _theta, double _time, double oldrhs,
                             double newrhs)
{
  dt    = _dt;
  theta = _theta;
...
void TimeSolver::MassMatrixVector(VectorInterface& gf, const VectorInterface& gu,
                                  double d) const
{
