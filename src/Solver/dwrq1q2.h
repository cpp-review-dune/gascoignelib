...
public:
  ...
  double ScalarProductWithFluctuations(nvector<double>& eta, const VectorInterface& gf,
                                       const VectorInterface& gz) const;
  ...
  double Estimator(nvector<double>& eta, VectorInterface& gf, const VectorInterface& gu,
