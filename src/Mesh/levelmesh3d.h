...
protected:
  ...
  void ConstructNodesOnFaceQ4(std::array<int, 81> &nodesonface, int vater,
                              int ni) const;
  void InsertHangingFacesQ4(QuarticHNStructure25 &hnq4face,
                            const std::array<int, 81> &nodesonface) const;
  void InsertHangingEdgesQ4(QuarticHNStructure5 &hnq4,
                            const std::array<int, 81> &nodesonface) const;
  void ConstructNodesOnFace(std::array<int, 25> &nodesonface, int vater,
                            int ni) const;
  void InsertHangingFaceQ4(QuarticHNStructure25 &hnq4face,
                           const std::array<int, 81> &nodesonface, int n1,
                           int n2, int n3, int n4,
                           const std::array<int, 25> &I) const;
  void InsertHangingEdgeQ4(QuarticHNStructure5 &hnq4,
                           const std::array<int, 81> &nof, int n1, int n2,
                           int n3, int n4, int i1, int i2, int i3, int i4,
                           int i5) const;
...
public:
  ...
  void
  ConstructHangingStructureQuadratic(QuadraticHNStructure3 &hnq2,
