...
protected:
  ...
  void GetGlobalOuterFaceOfChild(FaceVector &, const Hex &f, int c,
                                 int e) const;
...
public:
  ...
  void globalvertices_of_edge(const Hex &q, std::array<int, 2> &f,
                              int ie) const;
  void globalvertices_of_face(const Hex &q, std::array<int, 4> &f,
                              int ie) const;
  ...
  std::pair<int, int> GetChildFaces(const FaceVector &bigedge, int bighex,
                                    int i) const;
  ...
  void globalfacechildren_of_father(std::vector<FaceVector> &faces,
                                    const Hex &f) const;
  int LoadEdgeOfFace(const Hex &q, const FaceVector &F, int e,
                     EdgeVector &E) const;
