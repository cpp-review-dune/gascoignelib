...
protected:
  ...
  virtual void Construct2d(GascoigneMeshBase* NM, const LevelMesh2d* LM) const;
  virtual void Construct3d(GascoigneMeshBase* NM, const LevelMesh3d* LM) const;

  virtual LevelMesh2d* LevelUpdate2d(GascoigneMeshBase* GM, const IntSet& newquads, const IntSet& oldquads) const;
  virtual LevelMesh3d* LevelUpdate3d(GascoigneMeshBase* GM, const IntSet& newquads, const IntSet& oldquads) const;
  virtual void Loop2d();
  virtual void Loop3d();
