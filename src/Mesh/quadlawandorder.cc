                                              ...
                                              const Quad& f) const
{
  ...
  edges[0][1] = global_index(f, 4);
  edges[1][0] = global_index(f, 1);
  edges[1][1] = global_index(f, 4);

  edges[2][0] = global_index(f, 1);
  edges[2][1] = global_index(f, 5);
  edges[3][0] = global_index(f, 2);
  edges[3][1] = global_index(f, 5);

  edges[4][0] = global_index(f, 2);
  edges[4][1] = global_index(f, 6);
  edges[5][0] = global_index(f, 3);
  edges[5][1] = global_index(f, 6);

  edges[6][0] = global_index(f, 3);
  edges[6][1] = global_index(f, 7);
...
QuadLawAndOrder::local_edge_index(int q, const EdgeVector& edge) const
{
  for (int i = 0; i < 4; i++) {
    if ((edge[0] == quads[q].vertex(i)) &&
      ...
      return i;
    if ((edge[1] == quads[q].vertex(i)) &&
        (edge[0] == quads[q].vertex((i + 1) % 4)))
      return i;
  }
  return -1;
}
...
//  child_point_vertex(4)
{
  ...
  child_point_cell[0] = 0;
  child_point_vertex[0] = 0;
  child_point_cell[1] = 1;
  child_point_vertex[1] = 1;
  child_point_cell[2] = 2;
  child_point_vertex[2] = 2;
  child_point_cell[3] = 3;
  child_point_vertex[3] = 3;
