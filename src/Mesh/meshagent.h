...
public:
  ...
  std::map<int, BoundaryFunction<2>*>& GetShapes2d()
  {
    return _curved2d;
  }
  std::map<int, BoundaryFunction<3>*>& GetShapes3d()
  {
    return _curved3d;
  }
  const std::map<int, BoundaryFunction<2>*>& GetShapes2d() const
  {
    return _curved2d;
  }
  const std::map<int, BoundaryFunction<3>*>& GetShapes3d() const
  {
    return _curved3d;
  }

  void AddPeriodicMapping(int col, int col2, PeriodicMapping* map)
  {
  ...
  const GascoigneMultiGridMesh& GetMultiGrid() const
  {
    return *GMG;
  }
  GascoigneMultiGridMesh& GetMultiGrid()
  {
    return *GMG;
  }

  HierarchicalMesh* GetHierarchicalMesh()
  {
    return HMP;
  }
  const HierarchicalMesh* GetHierarchicalMesh() const
  {
    return HMP;
  }
  ...
  const GascoigneMesh* GetMesh(int l) const
  {
    return GMG->GetGascoigneMesh(l);
  }
