...
namespace Gascoigne
{
  ...
  public:
    ...
    virtual GascoigneMesh* GMesh(int l)
    {
    ...
    virtual void BasicInit(const std::string& gridname, int dim, int patchdepth, int epatcher,
			   bool goc2nc = false);

    virtual const GascoigneMultiGridMesh& GetMultiGrid() const
    {
      return *GMG;
    }
    virtual GascoigneMultiGridMesh& GetMultiGrid()
    {
      return *GMG;
    }

    virtual HierarchicalMesh* GetHierarchicalMesh()
    {
      return HMP;
    }
    ...
    virtual void ClearCl2g()
    {
      _cl2g.clear();
    }
    virtual const bool Goc2nc() const
    {
      return _goc2nc;
    }

    virtual const IntVector& Celll2g() const
    {
      return _celll2g;
    }
    virtual const IntMap& Cellg2l() const
    {
      return _cellg2l;
    }
  };
