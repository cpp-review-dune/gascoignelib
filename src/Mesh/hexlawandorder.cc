...
int HexLawAndOrder::LoadEdgeOfFace(const Hex& q, const FaceVector& F, int e, EdgeVector& E) const
{
    int face = local_face(q, F);
...
pair<int, int> HexLawAndOrder::GetChildFaces(const FaceVector& bigedge, int bighex, int i) const
{
...
void HexLawAndOrder::global_face_unsorted(FaceVector& faceglob, const Hex& h, int face) const
{
    FaceVector faceloc;
...
void HexLawAndOrder::global_edge_unsorted(EdgeVector& edgeglob, const Hex& h, int edge) const
{
    EdgeVector edgeloc;
...
void HexLawAndOrder::fill_middle_vertex_in_childs(const Hex& f, int number) const
{
...
void HexLawAndOrder::fill_face_vertex_in_childs(const Hex& f, int face, int number) const
{
...
void HexLawAndOrder::fill_edge_vertex_in_childs(const Hex& f, int edge, int number) const
{
...
int HexLawAndOrder::local_face(const Hex& f, const FaceVector& globalface) const
{
...
void HexLawAndOrder::childs_of_face(FaceVector& child, const Hex& f, int face) const
{
...
void HexLawAndOrder::GetGlobalOuterFaceOfChild(FaceVector& face, const Hex& f, int c, int e) const
{
    int childface    = 0;
...
void HexLawAndOrder::globalfacechildren_of_father(vector<FaceVector>& faces, const Hex& f) const
{
    size_t n = 24;
    faces.resize(n);
