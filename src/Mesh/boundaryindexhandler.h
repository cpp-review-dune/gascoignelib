...
public:
  void CopySetToVector(const std::vector<IntSet> &, const IntVector &,
                       VecMap &) const;
  ...
  void Equal(const IntSet &col, const VecMap &v, const VecMap &c,
             const VecMap &l, const VecMap &patch, const VecMap &patchlocal);
  void check() const;
