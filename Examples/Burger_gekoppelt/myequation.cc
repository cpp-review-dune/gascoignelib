                      ...
                      const TestFunction &N) const
{
  ...
  b[0] += (U[0].m() - (*oldu)[0].m())*(*H)[0].m() * N.m();
  b[1] += (U[1].m() - (*oldu)[1].m())*(*H)[0].m() * N.m();
                      ...
                      const TestFunction &N) const
{
  ...
  //// div v*h
  b[0]+= ((*V)[0].x()+(*V)[1].y())*U[0].m()*N.m();
  // v nabla h
  b[0]+=((*V)[0].m()*U[0].x()+(*V)[1].m()*U[0].y())*N.m();
                        ...
                        const TestFunction &N) const
{
  ...
  A(0,0)+=((*V)[0].x()+(*V)[1].y())*M.m()*N.m();

  A(0,0)+=((*V)[0].m()*M.x()+(*V)[1].m()*M.y())*N.m();
