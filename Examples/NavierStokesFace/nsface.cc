...
void NavierStokesFace2d::point_face(double h, const FemFunction &U1,
...
void NavierStokesFace2d::FaceForm(VectorIterator b, const FemFunction &U1,
...
void NavierStokesFace2d::FaceMatrix(EntryMatrix &A, const FemFunction &U1,
