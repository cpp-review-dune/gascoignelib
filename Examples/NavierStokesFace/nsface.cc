...
NavierStokesFace2d::NavierStokesFace2d(const ParamFile* pf)
  : FaceEquation()
{
...
void
NavierStokesFace2d::point_face(double h,
...
void
NavierStokesFace2d::FaceForm(VectorIterator b,
                             const FemFunction& U1,
                             const FemFunction& U2,
...
void
NavierStokesFace2d::FaceMatrix(EntryMatrix& A,
                               const FemFunction& U1,
                               const FemFunction& U2,
