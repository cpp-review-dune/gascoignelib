...
void LocalHierarchicalMesh3d::write_gup(const string& bname, const GlobalVector& u) const
{  
...
*/
  ...
  out << nnodes() << " vertexs"   << endl;
	...
	if(u.n()!=nnodes()) {cout<<"DDDDDDDDDDDDDDDDDDDDDDDDDD"<<endl; abort();}
  for (int i=0; i<nnodes(); i++)
    {
    std::vector<double> new_coord;
    new_coord.resize(3);
...
void LocalHierarchicalMesh3d::inner_vertex_newton3d(const IntVector& vnew,
