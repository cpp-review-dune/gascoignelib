...
class LocalMeshAgent : public virtual MeshAgentInterface {
private:
protected:
...
public:
  ...
  void BasicInit(const std::string &gridname, int dim, int patchdepth,
  ...
  void write_gup(const std::string &fname, const GlobalVector &u) const;
