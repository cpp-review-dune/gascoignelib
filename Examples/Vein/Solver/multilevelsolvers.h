...
public:
  ...
  double NewtonUpdate(GlobalVector &U_Vec_GV, double &rr, VectorInterface &x,
  ...
  void NewtonUpdateDisplacement(GlobalVector &U_Vec_GV, NLInfo &info_solid_disp,
                                NLInfo &info_meshmotion);
  void newton(VectorInterface &U_Vec, const VectorInterface &f,
              VectorInterface &r, VectorInterface &w, NLInfo &info_fsi_reduced,
              NLInfo &info_solid_disp, NLInfo &info_meshmotion);
  void UpdateVelocityandPressureinU(GlobalVector &U_Vec_GV, double factor,
                                    VectorInterface &dx);
  std::string Solve(VectorInterface &x, const VectorInterface &b,
                    NLInfo &info_fsi_reduced, NLInfo &info_solid_disp,
                    NLInfo &info_meshmotion);
