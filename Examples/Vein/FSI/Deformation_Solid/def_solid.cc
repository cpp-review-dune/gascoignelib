...
template<int DIM>
void
Def_Solid<DIM>::point_cell(int material) const
{
  if (material == 1)
    domain = 1;
  if (material == 2)
...
template<int DIM>
void
Def_Solid<DIM>::Form(VectorIterator b,
                     const FemFunction& U,
...
template<int DIM>
void
Def_Solid<DIM>::Matrix(EntryMatrix& A,
                       const FemFunction& U,
...
template<int DIM>
void
Def_Solid<DIM>::MatrixBlock(EntryMatrix& A,
                            const FemFunction& U,
...
template<int DIM>
void
Def_Solid<DIM>::lpspoint(double h,
                         const FemFunction& U,
                         const Vertex<DIM>& v) const
{}
template<int DIM>
void
Def_Solid<DIM>::StabForm(VectorIterator b,
                         const FemFunction& U,
...
template<int DIM>
void
Def_Solid<DIM>::StabMatrix(EntryMatrix& A,
                           const FemFunction& U,
