...
template <int DIM>
void DIV_proj<DIM>::Form(VectorIterator b, const FemFunction& U, const TestFunction& N) const
{
    if (domain < 0)  // fluid
    {
        VECTOR phi;
...
template <int DIM>
void DIV_proj<DIM>::Matrix(EntryMatrix& A, const FemFunction& U, const TestFunction& M,
...
template <int DIM>
void DIV_proj<DIM>::MatrixBlock(EntryMatrix& A, const FemFunction& U, const FemFunction& N) const
{
