...
void inline init_NV<3>(Eigen::Matrix<double, 3, 3>& NV, const FemFunction& U) {
  NV << U[1].x(), U[1].y(), U[1].z(), U[2].x(), U[2].y(), U[2].z(), U[3].x(), U[3].y(),
    U[3].z();
}
...
void inline init_NU<3>(Eigen::Matrix<double, 3, 3>& NU, const FemFunction& U) {
  NU << U[4].x(), U[4].y(), U[4].z(), U[5].x(), U[5].y(), U[5].z(), U[6].x(), U[6].y(),
    U[6].z();
}
...
void inline init_F<3>(Eigen::Matrix<double, 3, 3>& F, const FemFunction& U) {
  F << 1.0 + U[4].x(), U[4].y(), U[4].z(), U[5].x(), 1.0 + U[5].y(), U[5].z(), U[6].x(),
    U[6].y(), 1.0 + U[6].z();
}
...
template <int DIM>
void inline init_dtU(Eigen::Matrix<double, DIM, 1>& dtU,
                     const FemFunction&             U,
...
template <>
void inline init_dtU<2>(Eigen::Matrix<double, 2, 1>& dtU,
                        const FemFunction&           U,
                        const FemFunction&           OLD) {
  dtU << U[3].m() - OLD[3].m(), U[4].m() - OLD[4].m();
}
template <>
void inline init_dtU<3>(Eigen::Matrix<double, 3, 1>& dtU,
                        const FemFunction&           U,
                        const FemFunction&           OLD) {
...
template <>
void inline init_dtU_bdf2<2>(Eigen::Matrix<double, 2, 1>& dtU,
                             const FemFunction&           U,
                             const FemFunction&           OLD,
                             const FemFunction&           OLDOLD) {
  dtU << 1.5 * U[3].m() - 2. * OLD[3].m() + .5 * OLDOLD[3].m(),
    1.5 * U[4].m() - 2. * OLD[4].m() + .5 * OLDOLD[4].m();
}
template <>
void inline init_dtU_bdf2<3>(Eigen::Matrix<double, 3, 1>& dtU,
                             const FemFunction&           U,
                             const FemFunction&           OLD,
                             const FemFunction&           OLDOLD) {
  dtU << 1.5 * U[4].m() - 2. * OLD[4].m() + .5 * OLDOLD[4].m(),
    1.5 * U[5].m() - 2. * OLD[5].m() + .5 * OLDOLD[5].m(),
    1.5 * U[6].m() - 2. * OLD[6].m() + .5 * OLDOLD[6].m();
}
