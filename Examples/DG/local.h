...
public:
  ...
  void point_edge(bool internaledge, double h, const FemFunction &U1,
  ...
  void EdgeForm1(VectorIterator b, const FemFunction &U1, const FemFunction &U2,
  ...
  void EdgeForm2(VectorIterator b, const FemFunction &U1, const FemFunction &U2,
                 const TestFunction &N) const {
    // continuity
    b[0] += 1.e2 / _h * (U2[0].m() - U1[0].m()) * N.m();
  ...
  void EdgeMatrix11(EntryMatrix &A, const FemFunction &U1,
  ...
  void EdgeMatrix12(EntryMatrix &A, const FemFunction &U1,
                    const FemFunction &U2, const TestFunction &M,
                    const TestFunction &N) const {
    // continuity and boundary
    A(0, 0) += -1.e2 / _h * (M.m()) * N.m();
  ...
  void EdgeMatrix21(EntryMatrix &A, const FemFunction &U1,
                    const FemFunction &U2, const TestFunction &M,
                    const TestFunction &N) const {
    // continuity and boundary
    A(0, 0) += 1.e2 / _h * (-M.m()) * N.m();
  ...
  void EdgeMatrix22(EntryMatrix &A, const FemFunction &U1,
                    const FemFunction &U2, const TestFunction &M,
                    const TestFunction &N) const {
    // continuity and boundary
    A(0, 0) += 1.e2 / _h * (M.m()) * N.m();
