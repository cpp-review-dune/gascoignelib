...
public:
  ...
  void BasicInit(const Gascoigne::ParamFile *pf) {
    ...
    GetRightHandSidePointer() = new Gascoigne::RightHandSideByEquation(
        GetEquation(), GetExactSolution());
    GetDirichletDataPointer() =
        new Gascoigne::DirichletDataByExactSolution(GetExactSolution());
...
public:
  ...
  std::string GetName() const { return "LeastSquaresFunctional"; }
};
...
public:
  ...
  std::string GetName() const { return "LocalDomain"; }
};
