...
/*------------------------------------------------------*/
/*
  FineHierarchicalMesh3d::FineHierarchicalMesh3d(const FineHierarchicalMesh3d&
  H) : HierarchicalMesh(), HexLaO(hexs)
  {
  *this = H;
  }
*/
/*------------------------------------------------------*/
/*
  FineHierarchicalMesh3d& FineHierarchicalMesh3d::operator=(const
  FineHierarchicalMesh3d& H)
  {
