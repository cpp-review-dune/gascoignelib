		...
		if (color==7)
		  {
			...
			b[1] += -normal[0]*fact_time * ( (x-center[0])*(x-center[0])+(y-center[1])*(y-center[1])+(z-center[2])*(z-center[2])-radius*radius)/(-radius*radius);
			b[2] += -normal[1]*fact_time *( (x-center[0])*(x-center[0])+(y-center[1])*(y-center[1])+(z-center[2])*(z-center[2])-radius*radius)/(-radius*radius);
			b[3] += -normal[2]*fact_time * ( (x-center[0])*(x-center[0])+(y-center[1])*(y-center[1])+(z-center[2])*(z-center[2])-radius*radius)/(-radius*radius);
		  }
	  }
};
