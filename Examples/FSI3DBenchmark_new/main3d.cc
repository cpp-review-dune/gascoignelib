...
{
  ParamFile pf_fsi_red("fsibench3d_reduced.param");
  ParamFile pf_meshmotion("fsibench3d_meshmotion.param");
  ParamFile pf_def_solid("fsibench3d_def_solid.param");
  
  ParamFile pf_fsi_main("fsibench3d_reduced.param");
  ParamFile pf("fsibench3d_reduced.param");
  ...
  vector<Vertex3d> v1;  v1.push_back(Vertex3d(0.45,0.15,0.15));
