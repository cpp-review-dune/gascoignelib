...
public:
  ...
  HASHMAP<int, std::vector<int>> __solid_interface_cells,
    __fluid_interface_cells;
...
public:
  void InitInterfaceComponents(const std::vector<int> delf,
...
template<class BASE>
class AleDiscretization
  : public AleBaseDiscretization
  , virtual public BASE
{
