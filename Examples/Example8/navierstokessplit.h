...
public:
  ...
  void Matrix(Gascoigne::EntryMatrix& A,
              const Gascoigne::FemFunction& U,
  ...
  void StabForm(Gascoigne::VectorIterator b,
                const Gascoigne::FemFunction& U,
                const Gascoigne::FemFunction& UP,
                const Gascoigne::TestFunction& N) const;

  void StabMatrix(Gascoigne::EntryMatrix& A,
                  const Gascoigne::FemFunction& U,
                  const Gascoigne::TestFunction& Np,
                  const Gascoigne::TestFunction& Mp) const;
};
