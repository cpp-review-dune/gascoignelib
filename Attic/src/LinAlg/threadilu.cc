...
#pragma omp parallel for schedule(static, 1)
  for (int i = 0; i < __n_threads; ++i) {
    if (__ncomp == 1)
      __local_ilu[i] = new ThreadSparseBlockIlu<FMatrixBlock<1>>;
    if (__ncomp == 2)
      __local_ilu[i] = new ThreadSparseBlockIlu<FMatrixBlock<2>>;
    if (__ncomp == 3)
      __local_ilu[i] = new ThreadSparseBlockIlu<FMatrixBlock<3>>;
    if (__ncomp == 4)
      __local_ilu[i] = new ThreadSparseBlockIlu<FMatrixBlock<4>>;
    if (__ncomp == 5)
      __local_ilu[i] = new ThreadSparseBlockIlu<FMatrixBlock<5>>;
    if (__ncomp == 6)
      __local_ilu[i] = new ThreadSparseBlockIlu<FMatrixBlock<6>>;
    if (__ncomp == 7)
      __local_ilu[i] = new ThreadSparseBlockIlu<FMatrixBlock<7>>;
    if (__ncomp == 8)
      __local_ilu[i] = new ThreadSparseBlockIlu<FMatrixBlock<8>>;
  }
