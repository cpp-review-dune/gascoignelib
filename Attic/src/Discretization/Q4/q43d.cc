...
int
Q43d::GetPatchNumber(const Vertex3d& p0, Vertex3d& p) const
{
  int iq;
...
void
Q43d::VertexTransformation(const Vertex3d& p0, Vertex3d& p, int iq) const
{
  nmatrix<double> T;
  Transformation(T, iq);
...
void
Q43d::BasicInit(const ParamFile* paramfile)
{
