...
public:
  ...
  virtual void FaceForm(const FaceEquation& EQ,
                        LocalVector& F,
                        const FemInterface& FEM1,
                        const FemInterface& FEM2,
                        const LocalVector& U) const = 0;
  virtual void FaceMatrix(const FaceEquation& EQ,
                          EntryMatrix& E,
                          const FemInterface& FEM1,
                          const FemInterface& FEM2,
                          const LocalVector& U) const = 0;
...
{
protected:
  void universal_point_face(const FemInterface& FEM1,
                            const FemInterface& FEM2,
                            FemFunction& U1,
                            FemFunction& U2,
...
public:
  ...
  void FaceForm(const FaceEquation& EQ,
                LocalVector& F,
                const FemInterface& FEM1,
                const FemInterface& FEM2,
                const LocalVector& U) const;
  void FaceMatrix(const FaceEquation& EQ,
                  EntryMatrix& E,
                  const FemInterface& FEM1,
                  const FemInterface& FEM2,
                  const LocalVector& U) const;
