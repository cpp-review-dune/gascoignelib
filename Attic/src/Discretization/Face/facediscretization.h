...
protected:
  ...
  virtual void LocalToGlobalFace(GlobalVector& f,
                                 const LocalVector& F,
                                 int iq,
                                 double s) const;
  virtual void GlobalToLocalFace(LocalVector& U,
                                 const GlobalVector& u,
                                 int iq) const;
  virtual void LocalToGlobalFace(MatrixInterface& A,
                                 EntryMatrix& E,
                                 int iq,
                                 double s) const;
...
public:
  ...
  virtual void FaceForm(GlobalVector& f,
                        const GlobalVector& u,
                        const FaceEquation& EQ,
                        double d) const;
  virtual void FaceMatrix(MatrixInterface& A,
                          const GlobalVector& u,
                          const FaceEquation& EQ,
                          double) const;
};
