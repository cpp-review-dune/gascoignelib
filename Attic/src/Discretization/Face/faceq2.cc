  ...
  for (std::map<int, std::array<int, 2>>::const_iterator it = fm.begin();
    ...
    for (int iy = 0; iy < 3; ++iy)
      for (int ix = 0; ix < 3; ++ix)
        if (n0 == 0)
          ei[5 * iy + ix] = I0[6 - 3 * ix + iy];
        else if (n0 == 1)
          ei[5 * iy + ix] = I0[3 * iy + ix];
        else if (n0 == 2)
          ei[5 * iy + ix] = I0[2 + 3 * ix - iy];
        else if (n0 == 3)
          ei[5 * iy + ix] = I0[8 - ix - 3 * iy];
    ...
    for (int iy = 0; iy < 3; ++iy)
      for (int ix = 1; ix < 3; ++ix)
        if (n0 == 0)
          ei[5 * iy + ix + 2] = I1[2 + 3 * ix - iy];
        else if (n0 == 1)
          ei[5 * iy + ix + 2] = I1[8 - 3 * iy - ix];
        else if (n0 == 2)
          ei[5 * iy + ix + 2] = I1[6 - 3 * ix + iy];
        else if (n0 == 3)
          ei[5 * iy + ix + 2] = I1[3 * iy + ix];
