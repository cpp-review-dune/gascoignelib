...
DwrFem3d::DwrFem3d() : Q23d() { HNLow = new HNStructureQ13d; }
...
void DwrFem3d::ReInit(const GascoigneMesh *MP) {
  Q23d::ReInit(MP);
...
void DwrFemQ1Q23d::DiracRhsPoint(GlobalVector &f,
...
void DwrFemQ1Q23d::Form(GlobalVector &f, const GlobalVector &u,
...
void DwrFemQ1Q23d::AdjointForm(GlobalVector &f, const GlobalVector &u,
                               const Equation &EQ, double d) const {
  nmatrix<double> TH, TL;
...
void DwrFemQ1Q23d::BoundaryForm(GlobalVector &f, const GlobalVector &u,
                                const IntSet &Colors,
...
void DwrFemQ1Q23d::Rhs(GlobalVector &f, const DomainRightHandSide &RHS,
                       double s) const {
  nmatrix<double> TH, TL;
...
void DwrFemQ1Q23d::BoundaryRhs(GlobalVector &f, const IntSet &Colors,
...
void Gascoigne::DwrFemQ1Q23d::MassForm(GlobalVector &f, const GlobalVector &u,
...
void DwrFemQ1Q23d::LocalToGlobal(MatrixInterface &A, EntryMatrix &E, int iq,
                                 double s) const {
...
void DwrFemQ2Q13d::DiracRhsPoint(GlobalVector &f,
                                 const DiracRightHandSide &DRHS,
                                 const Vertex3d &p0, int i, double s) const {
  __F.ReInit(f.ncomp(), GetFem()->n());
...
void DwrFemQ2Q13d::Form(GlobalVector &f, const GlobalVector &u,
                        const Equation &EQ, double d) const {
  nmatrix<double> TH, TL;
...
void DwrFemQ2Q13d::AdjointForm(GlobalVector &f, const GlobalVector &u,
                               const Equation &EQ, double d) const {
  nmatrix<double> TH, TL;
...
void DwrFemQ2Q13d::BoundaryForm(GlobalVector &f, const GlobalVector &u,
                                const IntSet &Colors,
                                const BoundaryEquation &BE, double d) const {
  nmatrix<double> TH, TL;
...
void DwrFemQ2Q13d::Rhs(GlobalVector &f, const DomainRightHandSide &RHS,
                       double s) const {
  nmatrix<double> TH, TL;
...
void DwrFemQ2Q13d::BoundaryRhs(GlobalVector &f, const IntSet &Colors,
                               const BoundaryRightHandSide &NRHS,
                               double s) const {
  nmatrix<double> TH, TL;
...
void Gascoigne::DwrFemQ2Q13d::MassForm(GlobalVector &f, const GlobalVector &u,
                                       const TimePattern &TP, double s) const {
  nmatrix<double> TH, TL;
...
void DwrFemQ2Q13d::LocalToGlobal(MatrixInterface &A, EntryMatrix &E, int iq,
                                 double s) const {
  nvector<int> indices = GetLocalIndices(iq);
