...
namespace Gascoigne
{
  ...
  public:
    ...
    virtual void AddNodeVector(const std::string &,
                               const VectorInterface &q) = 0;
    virtual void AddCellVector(const std::string &,
                               const VectorInterface &q) = 0;
    ...
    //
    virtual void
    Visu(const std::string &name, const VectorInterface &u, int i) const = 0;
    virtual void Write(const VectorInterface &u,
                       const std::string &filename) const = 0;
    virtual void Read(VectorInterface &u,
                      const std::string &filename) const = 0;
    ...
    virtual void TimeRhsOperator(VectorInterface &f,
    ...
    {
      std::cerr << "\"SolverInterface::L2Projection\" not written!"
                << std::endl;
      abort();
    }
    ...
    //
    virtual void
    Form(VectorInterface &y, const VectorInterface &x, double d) const = 0;
    virtual void
    ...
    virtual void residualgmres(VectorInterface &y,
                               ...
                               const VectorInterface &b) const = 0;
    virtual void MatrixResidual(VectorInterface &y,
                                const VectorInterface &x,
                                const VectorInterface &b) const = 0;
    virtual void
    vmult(VectorInterface &y, const VectorInterface &x, double d) const = 0;
    virtual void
    vmulteq(VectorInterface &y, const VectorInterface &x, double d) const = 0;
    virtual void smooth(int niter,
                        VectorInterface &y,
                        const VectorInterface &x,
                        VectorInterface &h) const = 0;
    ...
    virtual void MassMatrixVector(VectorInterface &f,
                                  ...
                                  double d) const = 0;
    virtual void InverseMassMatrix(VectorInterface &u,
                                   const VectorInterface &f) const {};
    ...
    virtual double ScalarProduct(const VectorInterface &y,
                                 const VectorInterface &x) const = 0;
    virtual void
    Equ(VectorInterface &dst, double s, const VectorInterface &src) const = 0;
    virtual void
    Add(VectorInterface &dst, double s, const VectorInterface &src) const = 0;
    virtual void SAdd(double s1,
                      VectorInterface &dst,
                      double s2,
                      const VectorInterface &src) const = 0;
