...
public:
  ...
  virtual void SetTimeData(double dt, double theta, double time,
                           double oldrhs = -1, double newrhs = -1){};
  ...
  virtual void MatrixResidual(VectorInterface &y, const VectorInterface &x,
                              const VectorInterface &b) const = 0;
  virtual void vmult(VectorInterface &y, const VectorInterface &x,
                     double d) const = 0;
  virtual void vmulteq(VectorInterface &y, const VectorInterface &x,
                       double d) const = 0;
  virtual void smooth(int niter, VectorInterface &y, const VectorInterface &x,
  ...
  virtual double
  ScalarProductWithFluctuations(DoubleVector &eta, const VectorInterface &gf,
