...
namespace Gascoigne
{
  ...
  public:
    ...
    {
      std::cerr
          << "\"DiscretizationInterface::BoundaryMassMatrix\" not written!"
          << std::endl;
      abort();
    }
    ...
    void
    DiracRhs(GlobalVector &f, const DiracRightHandSide &DRHS, double s) const
    {
    ...
    {
      std::cerr
          << "\"DiscretizationInterface::InterpolateSolution\" not written!"
          << std::endl;
    }
    ...
    {
      std::cerr
          << "\"DiscretizationInterface::GetBoundaryMassDiag\" not written!"
          << std::endl;
      abort();
    }
